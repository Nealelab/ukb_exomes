...
def get_ukb_source_tsv_path(sex: str = 'both_sexes_no_sex_specific', tranche: str = CURRENT_TRANCHE):
    return f'gs://phenotype_pharma/PHESANT_output/{tranche}/{TRANCHE_PHENO_DATA[tranche]}/phesant_output_combined_{sex}.tsv'
...
def get_ukb_pheno_ht_path(sex: str = 'both_sexes_no_sex_specific', tranche: str = CURRENT_TRANCHE):
    return f'gs://ukbb-pharma-exome-analysis/{tranche}/{TRANCHE_PHENO_DATA[tranche]}/phenotype/ht/{sex}.ht'


def get_ukb_pheno_mt_path(data_type: str, sex: str = 'full', tranche: str = CURRENT_TRANCHE):
    return f'gs://ukbb-pharma-exome-analysis/{tranche}/{TRANCHE_PHENO_DATA[tranche]}/phenotype/{sex}/{data_type}.mt'
